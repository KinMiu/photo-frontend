...
function Login() {
  ...
  return (
    <div className='d-flex p-2 justify-content-center align-items-center text-items-center bg-light-subtle' style={{width: '100%', height: '100%'}}>
      <div className="container d-flex mt-4 p-3 rounded  justify-content-center align-items-center mt-lg-5 p-lg-3 bg-success bg-opacity-50" style={{ width: '350px', }}>
